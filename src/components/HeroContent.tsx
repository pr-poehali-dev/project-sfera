    ...
    <main className="absolute bottom-8 left-8 z-20 max-w-lg">
      <div className="text-left">
        ...
        >
          ...
          <span className="text-white/90 text-xs font-light relative z-10">Стоматологическая клиника · Москва</span>
        </div>
        ...
        <h1 className="text-5xl md:text-6xl md:leading-16 tracking-tight font-light text-white mb-4">
          ...
          <br />
          <span className="font-light tracking-tight text-white">красивая улыбка</span>
        </h1>
